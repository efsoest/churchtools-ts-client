...
export function instanceOfVerificationStatus(value: any): boolean {
    for (const key in VerificationStatus) {
        if (Object.prototype.hasOwnProperty.call(VerificationStatus, key)) {
            if (VerificationStatus[key as keyof typeof VerificationStatus] === value) {
                return true;
            }
        }
    }
...
export function VerificationStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): VerificationStatus {
