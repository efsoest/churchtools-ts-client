...
- 2026-02-10: npm-Release-Workflow auf manuellen Trigger umgestellt (`workflow_dispatch` mit `release_tag`) und auf npm Trusted Publishing (OIDC, ohne `NPM_TOKEN`) migriert; Versionsabgleich Tag vs. `package.json` bleibt als Safety-Gate aktiv.
